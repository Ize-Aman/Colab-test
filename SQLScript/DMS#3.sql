...
ALTER COLUMN Password VARCHAR(10) COLLATE Latin1_General_CS_AS NOT NULL;
...
--Insert into UserDeail
INSERT INTO UserDetail (UserName, Password, UserType) VALUES
('Henok Mesfin', 0000, 'C'),
('Aymen Abdo', 1, 'C'),
('Ammanuel', 2, 'A');
...
INSERT INTO Customer (F_Name, L_Name, Phone, Email, Gender, Address) VALUES
('John', 'Doe', '1234567890', 'john.doe@gmail.com', 'M', '123 Main St'),
('Jane', 'Smith', '0987654321', 'jane.smith@gmail.com', 'F', '456 Oak Ave'),
('Emily', 'Brown', '1122334455', 'emily.brown@gmail.com', 'F', '789 Maple Rd'),
('Michael', 'Johnson', '2233445566', 'michael.johnson@gmail.com', 'M', '321 Cedar Ln'),
('Sophia', 'Davis', '3344556677', 'sophia.davis@gmail.com', 'F', '654 Birch Blvd'),
('David', 'Wilson', '4455667788', 'david.wilson@gmail.com', 'M', '987 Spruce St'),
('Olivia', 'Martinez', '5566778899', 'olivia.martinez@gmail.com', 'F', '147 Palm Dr'),
('Ethan', 'Clark', '6677889900', 'ethan.clark@gmail.com', 'M', '369 Aspen Rd'),
('Liam', 'Taylor', '7788990011', 'liam.taylor@gmail.com', 'M', '258 Pine St'),
('Emma', 'Anderson', '8899001122', 'emma.anderson@gmail.com', 'F', '147 Palm Dr');

INSERT INTO Customer (F_Name, L_Name, Phone, Email, Gender, Address) VALUES
('Henok', 'Mesfin', '0909090909', null, 'M', 'Unspecified'),
('Aymen', 'Abdo', '0909090909', null, 'M', 'Unspecified');
