...
public class Menu extends JFrame {
	...
	public Menu() {
		...
		String[] img = { "images\\images (2).jpg", "images\\images (1).jpg", "images\\Monster.png",
				"images\\images (2).jpg", "images\\images (1).jpg", "images\\Lasagna.jpg" };
		...
		for (i = 0; i < 6; i++) {
			...
			lblNewLabel_2_1.setIcon(new ImageIcon(Menu.class.getResource(img[i])));
